...
export {}
declare global {
  const CheckTimeD: typeof import('../../composables/useMoments')['CheckTimeD']
  const Dialog: typeof import('quasar')['Dialog']
  const GetConfig: typeof import('../../composables/fetch')['GetConfig']
  const Notify: typeof import('quasar')['Notify']
  const OpenPrompt: typeof import('../../composables/useQuasar')['OpenPrompt']
  const ShowPrompt: typeof import('../../composables/useQuasar')['ShowPrompt']
  const ShowSnack: typeof import('../../composables/useQuasar')['ShowSnack']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly CheckTimeD: UnwrapRef<typeof import('../../composables/useMoments')['CheckTimeD']>
    readonly Dialog: UnwrapRef<typeof import('quasar')['Dialog']>
    readonly GetConfig: UnwrapRef<typeof import('../../composables/fetch')['GetConfig']>
    readonly Notify: UnwrapRef<typeof import('quasar')['Notify']>
    readonly OpenPrompt: UnwrapRef<typeof import('../../composables/useQuasar')['OpenPrompt']>
    readonly ShowPrompt: UnwrapRef<typeof import('../../composables/useQuasar')['ShowPrompt']>
    readonly ShowSnack: UnwrapRef<typeof import('../../composables/useQuasar')['ShowSnack']>
