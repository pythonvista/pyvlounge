globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/James/Desktop/pyvlounge/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createError, getQuery, readBody, handleCors, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/radix3/dist/index.mjs';
import cache from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/memory-cache/index.js';
import { performance } from 'perf_hooks';
import { FilterXSS } from 'file://C:/Users/James/Desktop/pyvlounge/node_modules/xss/lib/index.js';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/James/Desktop/pyvlounge/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\James\\Desktop\\pyvlounge","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\James\\Desktop\\pyvlounge\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\James\\Desktop\\pyvlounge\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\James\\Desktop\\pyvlounge\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _nszolOGuMn = (function(nitro) {
...
const _CsB9R0 = defineEventHandler(async (event) => {
  const routeRules = getRouteRules(event);
...
const _MktaAz = defineEventHandler(async (event) => {
...
const _UpGEtP = defineEventHandler(async (event) => {
  const routeRules = getRouteRules(event);
...
const _d5oVx8 = defineEventHandler((event) => {
  const routeRules = getRouteRules(event);
  handleCors(event, routeRules.security.corsHandler);
});

const _lazy_0cbZnb = () => Promise.resolve().then(function () { return getconfig$1; });
const _lazy_90zxRR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/getconfig', handler: _lazy_0cbZnb, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_90zxRR, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _CsB9R0, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _MktaAz, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _UpGEtP, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _d5oVx8, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_90zxRR, lazy: true, middleware: false, method: undefined }
];
...
const getconfig = defineEventHandler((event) => {
  useRuntimeConfig();
  return "hiii";
});

const getconfig$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: getconfig
});
...
const getClientManifest = () => import('file://C:/Users/James/Desktop/pyvlounge/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/James/Desktop/pyvlounge/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
